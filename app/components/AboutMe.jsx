  ...
  return (
    <section class="text-white text-center place-self-center font-mono grid grid-cols-1 sm:grid-cols-12 gap-4 py-12">
      <div class="col-span-1 sm:col-start-2 sm:col-span-10 mt-10 md:mt-16 text-left flex flex-col h-full place-self-center">
        <h1 class="text-5xl font-pixel font-bold text-center text-white mb-4">About Me</h1>
        <div class="text-[#ADB7BA] text-lg lg:text-2xl text-center lg:text-left mb-6 mt-6 ml-10 tracking-wider leading-loose">
          <p  className="py-1">
            &gt; A {" "}
            <span class="font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-400 via-teal-300 to-green-400">Computer Science student</span> currently studying at <a href="https://www.blockeley.com/" class="font-bold text-transparent bg-clip-text bg-gradient-to-br from-orange-400 via-yellow-500 to-yellow-600 hover:underline">UC
          ...
          &gt; A{" "}
            ...
            who embraces discomfort while mastering new technology.
          </p>
        </div>
      </div>
    </section>
